...
function redactUnrevealedCards(chapterText, spreadCards, revealedCards, clarifierCards) {
    ...
    console.log(`[validator] Energy pass: initial=${initialEnergyCount}, patternMatches=${totalEnergyPatternMatches}, fallbackReplacements=${fallbackReplacements}, remaining=${energyCount}`);
    ...
    console.log(`[validator] Signature pass: matched=${signatureFound}, softened=${signatureSoftened}`);
